...
//the below code:
// - takes any argument that implements the Bite trait
// - it just so happens that we called it T
// - we define type T right in fn definition - and can later re-use in the code
